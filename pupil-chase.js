(()=>{
  ...
  .view-eye-inline{display:none!important}
  ...
  function buildEyes(){
    ...
    for(const spec of targetSpecs){
      ...
      eye.innerHTML='<span class="escape-iris"><span class="escape-pupil"></span></span><span class="escape-label">黒目をタッチしよう！</span>';
